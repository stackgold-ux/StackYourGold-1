...
const EducationalHub = () => {
  ...
  const featuredArticle2 = articles.find(a => a.id === '7stop');
              ...
              <div className="mb-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  >
                    ...
                    <div>
                      <span className="text-[10px] font-black text-primary uppercase tracking-[0.3em] block mb-2">{featuredArticle2?.category || 'PREMIUM STRATEGY'}</span>
                      <h3 className="text-2xl font-black text-white group-hover:text-primary transition-colors leading-tight mb-3">
                        {featuredArticle2?.title || 'The 7 Stops to Generational Wealth™'}
                      </h3>
                      <p className="text-text-muted text-sm leading-relaxed mb-4">
                        {featuredArticle2?.desc || "The definitive 7-step journey from fragile paper assets to an unbreakable family legacy."}
                      </p>
                      <span className="text-xs font-bold text-primary group-hover:underline flex items-center">
                        READ ARTICLE <ChevronRight size={14} className="ml-1 group-hover:translate-x-1 transition-transform" />
                      </span>
